...
struct ScenarioOrganizationView: View {
    ...
    private var phaseBadge: some View {
        ...
        // A2 revue a11y : light #1D4ED8 (4.94 sur accent 14%/ivoire),
        // dark = accent natif paleBlue (8.03 sur accent 14%/midnight)
        .foregroundColor(colorScheme == .dark ? SemanticColor.accent(for: colorScheme) : Color(hex: "1D4ED8"))
