package com.guyghost.wakeve.ios.ui.views
...
struct ChatView: View {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Menu {
                        ...
                        Button(action: { /* Media */ }) {
                            Label("Médias partagés", systemImage: "photo")
                        }
    ...
    private var connectionStatusBanner: some View {
        HStack {
            ...
            Text("Hors ligne - Les messages seront synchronisés")
        }
        .font(.caption)
    ...
    private var typingText: String {
        ...
        switch users.count {
        case 0: return ""
        case 1: return "\(users[0].userName) est en train d'écrire..."
        case 2: return "\(users[0].userName) et \(users[1].userName) sont en train d'écrire..."
        default: return "\(users[0].userName), \(users[1].userName) et \(users.count - 2) autres sont en train d'écrire..."
        }
    }
    ...
    private var messageInputBar: some View {
        VStack(spacing: 8) {
            ...
            HStack(spacing: 8) {
                ...
                // Text field
                TextField("Écrivez votre message...", text: $messageText, axis: .vertical)
    ...
    private func sectionLabel(_ section: CommentSection) -> String {
        ...
        case .ACCOMMODATION: return "🏠 Logement"
        case .FOOD: return "🍕 Repas"
...
struct MessageBubbleView: View {
    ...
    private func groupedReactions() -> [(emoji: String, count: Int)] {
        ...
        return grouped.map { ($0.key, $0.value.count) }.sorted by { $0.count > $1.count }
    }
