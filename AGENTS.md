...
Ce document définit les agents (humains et logiciels) pour l’application mobile de planification d’événements “Wakeve” en Kotlin Multiplatform. Il décrit leurs responsabilités, interfaces et handoffs, afin d’assurer un flux clair du sondage de disponibilités jusqu’à la planification complète et la synchronisation offline-first.
