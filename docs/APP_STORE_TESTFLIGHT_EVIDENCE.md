...
- `docs/ios-release-screen-evidence/release-screen-evidence-2026-06-13T12-53-27Z.md` records local simulator screenshot coverage for ROADMAP P1.2. It is useful preflight evidence only; event-detail and organization screenshots remain missing and all rows must be revalidated from the uploaded TestFlight build before closure.
