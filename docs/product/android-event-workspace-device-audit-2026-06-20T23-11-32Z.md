...
Generated: 2026-06-20T23:11:32Z
...
| Evidence asset directory | `~/Developer/dev/wakeve/docs/product/android-event-workspace-device-audit-assets-2026-06-20T23-11-32Z` |
...
```bash
mkdir -p "~/Developer/dev/wakeve/docs/product/android-event-workspace-device-audit-assets-2026-06-20T23-11-32Z"
adb -s "<serial>" shell monkey -p "com.guyghost.wakeve" 1
adb -s "<serial>" shell screencap -p "/sdcard/wakeve-<step>.png"
adb -s "<serial>" pull "/sdcard/wakeve-<step>.png" "~/Developer/dev/wakeve/docs/product/android-event-workspace-device-audit-assets-2026-06-20T23-11-32Z/"
adb -s "<serial>" shell screenrecord --time-limit 120 "/sdcard/wakeve-event-workspace-flow.mp4"
adb -s "<serial>" pull "/sdcard/wakeve-event-workspace-flow.mp4" "~/Developer/dev/wakeve/docs/product/android-event-workspace-device-audit-assets-2026-06-20T23-11-32Z/"
