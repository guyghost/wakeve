...
- Release-screen evidence audit: `./scripts/audit-ios-release-screen-evidence.sh` generated `docs/ios-release-screen-evidence/release-screen-evidence-2026-06-13T13-32-47Z.md`. It maps local simulator screenshots to ROADMAP P1.2, shows 3/5 required screens covered locally (onboarding, login/guest, create event), and records event-detail plus organization as the next uploaded-build capture targets.
