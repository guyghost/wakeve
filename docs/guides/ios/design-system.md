...
- **Immersion d'abord** : les parcours événementiels utilisent des fonds pleine page, des gradients expressifs et des cartes glass empilées.
...
- **Accessibilité native** : les surfaces glass doivent rester lisibles avec Reduce Transparency, contraste élevé, VoiceOver et Dynamic Type.
...
Surface standard pour cartes, groupes et panneaux.
...
Le composant applique le fallback opaque quand la transparence est réduite.
...
- Les surfaces glass doivent rester lisibles sans transparence.
