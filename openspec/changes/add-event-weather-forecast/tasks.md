...
- 2026-06-21 readiness refresh: `docs/weatherkit/weatherkit-device-validation-2026-06-20T22-44-14Z.md` still reports `PHYSICAL_IOS_DEVICE_NOT_TRACE_READY`; CoreDevice sees the physical iPhone, but Instruments lists it offline, `TEAM_ID`/`APPLE_TEAM_ID` is missing, there are `0` valid signing identities, and no provisioning profile matches `com.guyghost.wakeve`.
