...
The Payment Management capability supports shared event payments, settlement tracking, payment pot lifecycle, and Tricount handoff for confirmed event participants.
## Requirements
