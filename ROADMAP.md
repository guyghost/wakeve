...
- `APP_REVIEW_PHONE_NUMBER='+33123456789' ./scripts/lint-store-metadata.sh --ios-only` passe apres realignement: 3108 checks, 0 erreur, 1 warning.
...
- `APP_REVIEW_PHONE_NUMBER='+33123456789' ./scripts/lint-store-metadata.sh --ios-only` passe: 3108 checks, 0 erreur, 1 warning.
