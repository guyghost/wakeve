...
- Les fichiers `iosApp/src/Resources/en.lproj/Localizable.strings` et `iosApp/src/Resources/fr.lproj/Localizable.strings` passent `plutil -lint`, ont chacun 843 cles et aucune cle manquante entre EN/FR apres localisation des labels d'accessibilite du login, des controles release supplementaires, des textes de chargement release et des hints VoiceOver detectes par audit source renforce.
